 ...
 * <p/>
 * Created by jimmyhu on 2015/3/27.
 */
public class ConnectivityUtils {
    public static boolean checkNetworkAvailable(Context context) {
        final NetworkInfo localNetworkInfo = getActiveNetworkInfo(context);
     ...
     * @param subType TelephonyManager type
     * @return
     */
    ...
    public static boolean isConnectedFastEnough(Context context) {
        if (!isConnected(context))
            return false;
        final NetworkInfo localNetworkInfo = getActiveNetworkInfo(context);
        return isConnectionFast(localNetworkInfo.getType(), localNetworkInfo.getSubtype());
    }
}
